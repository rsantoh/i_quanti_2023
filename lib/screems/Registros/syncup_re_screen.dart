...
class SyncUpRePage extends StatelessWidget {
  const SyncUpRePage({ Key? key }) : super(key: key);
        ...
        child: Container(
          child: MaterialButton(
             ...
             child: Container(
                ...
                child: Text(
                'Actualizar ubicaciones \ndisponibles',textAlign: TextAlign.center,
                )
              ),
              onPressed: () {
                if(uiProvider.status){
                  
                  final syncpro = Provider.of<SyncDataProvider>(context, listen: false); 
